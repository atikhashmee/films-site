...
$episode = $db->query("SELECT COUNT(*) AS total_eps FROM episodes")->fetch_assoc()['total_eps'];
$videos =  $db->query("SELECT COUNT(*) AS total_video FROM movies")->fetch_assoc()['total_video'];
?>
<!DOCTYPE HTML>
<html>
<head>
