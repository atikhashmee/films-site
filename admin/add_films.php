...
if (isset($_POST['add'])) {
    ...
    if(isset($_POST['is_series'])){
      ...
      foreach ($movieOutputs->tv_results as $movieOutput) {
        ...
        //   echo json_enchode($genres_video);
        //   die();
          ...
          VALUES ('{$video_name}','{$video_description}','{$video_categories}','{$new_file_name_2}','{$new_file_name_2}','0','{$source}','{$rating}','{$year}','film','{$imdbid}','{$video_format}','1','{$features}')");
        ...
        if (!empty($movieOutput)) {
          ...
          //  $catName = str_replace(' ', '-', $catName);
            ...
            if ($im_url != "") {
                ...
                VALUES ('{$video_name}','{$video_description}','{$video_categories}','{$new_file_name_2}','{$new_file_name_2}','0','{$source}','{$rating}','{$year}','film','{$imdbid}','{$video_format}','{$features}')");
