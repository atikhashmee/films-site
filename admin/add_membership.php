...
if(isset($_POST['add_plan'])) {
    ...
    $dmy = $_POST['dmy'];
    $time_period = $time_period.' '.$dmy;
    $db->query("INSERT INTO membership_plan (membership_type,membership_plan,price,time_period) VALUES ('".$membership_type."','".$membership_plan."','".$price."','".$time_period."')");
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                              <div class="form-group">
                                  ...
                                  <select name="membership_type" class="form-control border-input" required>
                       ...
                       <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <br>
                                <input type="text" name="time_period" class="formcontrol border-input span2" placeholder="amount" id="dp1" required>
                                <select name="dmy" class="formcontrol" required>
