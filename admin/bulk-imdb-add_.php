...
VALUES ('".$season_id."','".$video_id."','".$episode_number."','','Discription Coming Soon.','814512c0eb40e98a0f15cf493f8c6096maxresdefault-1.jpg','".$source."','0','','','')");
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    if($movies->num_rows >= 1) {
                                                        while($movie = $movies->fetch_object()) {
                                                            $selected = '';
                                                            if(isset($_GET['sid']) && $_GET['sid'] == $movie->id){
                                                                $selected = 'selected="selected"';
                                                            }
                                                            echo '<option '.$selected.' value="'.$movie->id.'">'.$movie->movie_name.'('.$movie->movie_year.') '.$movie->imdbid.'</option>';
                                                        }
                                                    }
                                                    ?>
                                                    </select>
