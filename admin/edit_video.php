                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading panel-title"> Video Actors</div>
                                    <div class="panel-body"><a href="<?=$admin->getDomain()?>/admin/filmactor.php?id=<?php echo $id;?>" class="btn btn-success btn-fill btn-xs " style="margin-top:21px;"> Film Actors</a></div>
                                 <!-- <div class="panel-body"><a href="<textarea rows="5" class="form-control" >http://dissdemo.biz/film//admin/filmactor.php </textarea>"></div>-->
                                </div>
                            </div>
                        </div>
