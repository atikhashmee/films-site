...
if(isset($_POST['add'])) {
    ...
    $db->query("INSERT INTO genres (genre_name,is_kid_friendly) VALUES ('".$name."','".$is_kid_friendly."')");
              ...
              <div class="card">
                ...
                <div class="content">
                    ...
                    <form action="" method="post">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" name="category_name" class="form-control border-input" placeholder="Enter a name for this category" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <? } ?>
                        <div class="pull-left">
                            <button type="submit" name="add" class="btn btn-success btn-fill btn-wd">Add Category</button>
                        </div>
