            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        Pages
                        <a href="add_page.php" class="btn btn-success btn-fill btn-xs pull-left" style="margin-top:21px;"> <i class="ti-plus"></i> Add Page </a> </a>
                    </div>
                ...
                <div class="container-fluid">
                 ...
                 if($pages->num_rows >= 1) {
                    ...
                    while($page = $pages->fetch_object()) {
                        echo '<tr>';
                        echo '<td class="text-center">'.$page->id.'</td>';
                        echo '<td class="text-center">'.$page->page_name.'</td>';
                        echo '
