    ...
    if(is_object($user)) {
        ...
        try {
            ...
            $mail->SMTPDebug = 2;                                 // Enable verbose debug output
             ...
             $mail->Host = 'mail.dissdemo.biz';  // Specify main and backup SMTP servers
             $mail->SMTPAuth = false;                               // Enable SMTP authentication
            $mail->Username = 'mustafa@dissdemo.biz';                 // SMTP username
             $mail->Password = 'xtHe{)DLUT@U';                           // SMTP password
             $mail->SMTPSecure = 'ssl';
