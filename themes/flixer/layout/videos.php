    ...
    <div class="col-lg-12">
      <div class="my-list filter">
        ...
        while($movie = $movies->fetch_object()) {
          $muviko->newHomeMovieItem($movie->id,$movie->movie_thumb_image,$movie->movie_name,$movie->movie_year,$movie->movie_rating,$movie->is_series,$movie->last_season,$movie->watch,$movie->movie_year);
        }
        ?>
      </div>
        <?php
