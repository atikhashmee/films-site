 ...
 <div class="container">
  ...
  <div class="collapse navbar-collapse" id="navigation-example-2">
    <ul class="nav navbar-nav navbar-left">
      <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
          <?=$muviko->translate('Browse')?> <b class="caret"></b> </a>
      ...
      <form action="<?=$muviko->getDomain()?>/search.php" method="get" class="navbar-form navbar-left" style="display:none;" role="search">
        <div class="form-group">
         <div class="input-group search-input">
          ...
          placeholder="<?=$muviko->translate('Title')?>">
        </div>
      </div>
    </form>
    ...
    <?php if(!$muviko->verifySession(false)) { ?>
      <li>
        <a href="#" class="btn btn-danger btn-fill" data-toggle="modal" data-target="#login">
          <?=$muviko->translate('Sign_In')?></a>
      </li>
    <? } else { ?>
      <li class="dropdown">
        ...
        <?php if(!$muviko->isKid()) { ?>
          <ul class="dropdown-menu dropdown-menu-right">
              <?php if($muviko->verifyAdmin(false)) { ?>
                <li>
                  <a href="<?=$muviko->getDomain()?>/admin/index.php">
                  <?=$muviko->translate('Admin')?></a>
                </li>
                <li class="divider"></li>
              <?php  } ?>
...
<div class="container animated fadeIn" onclick="hideSearch();">
  <div class="row">
    <div class="col-md-5 centered payment-modal">
      <div class="panel panel-danger"> 
          ...
          <div class="panel-body">
            <form action="" method="post">
              ...
              <button type="submit" name="continue" class="btn btn-danger btn-fill pull-right"><?=$muviko->translate('Continue')?></button>
            </form>
          </div>
      </div>
      <!-- <div class="col-md-5 centered pricing-page">
        ...
        <div class="panel-footer">
         <a class="btn btn-danger btn-block btn-fill" data-toggle="modal" data-target="#pay"><?=strtoupper($muviko->translate('Subscribe'))?></a>
       </div>
     </div> -->
   </div>
 </div>
