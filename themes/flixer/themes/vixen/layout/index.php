...
style="
background-image: linear-gradient(to bottom, rgba(16, 20, 25, 0.2), rgba(16, 20, 25, 1)), url('<?=UPLOADS_PATH?>/poster_images/<?=$featured_movie->movie_poster_image?>');
background-image: -moz-linear-gradient(top, rgba(16, 20, 25, 0.2), rgba(16, 20, 25, 1)), url('<?=UPLOADS_PATH?>/poster_images/<?=$featured_movie->movie_poster_image?>');
background-image: -o-linear-gradient(top, rgba(16, 20, 25, 0.2), rgba(16, 20, 25, 1)), url('<?=UPLOADS_PATH?>/poster_images/<?=$featured_movie->movie_poster_image?>');
background-image: -ms-linear-gradient(top, rgba(16, 20, 25, 0.2), rgba(16, 20, 25, 1)), url('<?=UPLOADS_PATH?>/poster_images/<?=$featured_movie->movie_poster_image?>');
background-image: -webkit-linear-gradient(top, rgba(0, 0, 0, 0.2), rgba(16, 20, 25, 1)), url('<?=UPLOADS_PATH?>/poster_images/<?=$featured_movie->movie_poster_image?>');
);
">
...
<div class="container animated fadeIn" onclick="hideSearch();">
  <div class="home-movie-info">
   ...
   <a href="video/<?=$featured_movie->id?>" class="btn btn-success btn-fill" style="margin-right:10px;"> <i class="ti-control-play"></i>
