  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="setting-container">
        <div class="col-lg-7">
          <h1><?=$muviko->translate('Change_Phone')?></h1>
          <?php if(isset($error)) { ?> <div class="alert alert-danger"> <?=$error?> </div> <?php } ?>
          <form action="" method="post">
           <div class="form-group">
            <label class="first"><?=$muviko->translate('Mobile_Phone_Number')?></label>
            <div class="clearfix"></div>
            <?=$muviko->user->phone?>
          </div>
          <div class="form-group">
            <label><?=$muviko->translate('New_Phone_Number')?></label>
          ...
          <div class="form-group">
            <label><?=$muviko->translate('Confirm_Password')?></label>
            <input type="password" name="confirm_password" class="form-control input-dark">
          </div>
          <button type="submit" name="save" class="btn btn-success btn-fill"><?=$muviko->translate('Save')?></button>
          <a href="settings.php" class="btn btn-default btn-fill"><?=$muviko->translate('Cancel')?></a>
        </form>
      </div>
    </div>
  </div>
