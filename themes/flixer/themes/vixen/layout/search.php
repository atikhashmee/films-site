    ...
    <div class="col-lg-12">
      <div class="my-list">
        ...
        while($result = $results->fetch_object()) {
          $muviko->newHomeMovieItem($result->id,$result->movie_thumb_image,$result->movie_name,$result->movie_year,$result->movie_rating,$result->is_series,$result->last_season);
        }
        ?>
      </div>
    </div>
